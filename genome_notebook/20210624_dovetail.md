...
-Pacbio- 2 smart ccells - full chromosome level genome
 ...
 - 10% muscle, 10% gills, 40% brain, 
 - same fish for genome and transcriptome.
 - RNA latter, (celia used trisol)
 -  less toxic and better for long term preserve
 -  room temp ~1 week
 -  Zimo- RNA/DNA shield- then RNA extraction from 
 -  trisol needs to be cleaned 
